...
//z: smaller the value the closer the landmark is to the camera
...
new ControlPanel(controlsElement, {
  ...
  smoothLandmarks: true, //true, the solution filters pose landmarks across different input images to reduce jitter,
